    ...
    const eventsSubscription = supabase
      ...
      .on(
        "postgres_changes",
        {
          ...
          schema: "public",
          table: "events",
          filter: "event_type=eq.hackathon",
        },
        (payload) => {
      ...
      >
        <div ref={ref} className="relative w-full overflow-hidden">
          ...
          <div className="absolute inset-0 flex flex-col justify-center items-center">
            ...
            >
              Experience innovative hackathons at Texus Fest! Solve real-world
              problems and showcase your coding skills in these exciting events.
            </motion.p>
          </div>
        </div>
            ...
            >
              {filteredEvents.length > 0 ? (
                ...
                >
                  ...
                  >
                    Hackathon Events Will Be Announced Soon!
                  </motion.h3>
                  <motion.p
                  ...
                  >
                    Stay tuned for exciting hackathons. Follow us on social
                    media for updates!
                  </motion.p>
                </motion.div>
              )}
